...
impl App<'_> {
    ...
    pub fn input_handler(&mut self, input: KeyCode) -> Option<Cmd> {
        match input {
            KeyCode::Char('q') => {
    ...
    fn si_prefix(num: u64) -> (u64, String) {
        ...
        match n.log(10.0) as u64 {
            0..=2 => (10_u64.pow(0), String::from("")),
            3..=5 => (10_u64.pow(3), String::from("K")),
            6..=8 => (10_u64.pow(6), String::from("M")),
            9..=11 => (10_u64.pow(9), String::from("G")),
            12..=14 => (10_u64.pow(12), String::from("T")),
            15..=17 => (10_u64.pow(15), String::from("P")),
